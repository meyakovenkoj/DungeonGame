...
void Menu::create(View view){
	quest_texture.loadFromFile("/Users/ivanyakovenko/Documents/DungeonGame/DungeonGame/images/backmenu.png");
...
Menu::Menu(View view){
	quest_texture.loadFromFile("/Users/ivanyakovenko/Documents/DungeonGame/DungeonGame/images/missionbg.jpg");
	s_quest.setTexture(quest_texture);
